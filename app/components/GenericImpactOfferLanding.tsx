...
export default function GenericImpactOfferLanding({campaign,lang,slug}:{campaign:GenericImpactCampaign;lang:Lang;slug:string}){
  ...
  return <main className="genericOffer" style={{minHeight:'100vh',background:'#f4f7f4',color:'#0b1711',fontFamily:'Arial,Helvetica,sans-serif'}}>
    <header className="genericOfferHeader" style={{position:'sticky',top:0,zIndex:20,background:'rgba(244,247,244,.92)',backdropFilter:'blur(16px)',borderBottom:'1px solid #dde6df'}}>
      <div className="genericOfferHeaderIn" style={{maxWidth:1180,margin:'auto',padding:'16px 22px',display:'flex',alignItems:'center',justifyContent:'space-between',gap:18}}>
    ...
    <section className="genericOfferHeroSection" style={{maxWidth:1180,margin:'30px auto 0',padding:'0 22px'}}>
      <div className="genericOfferHero" style={{position:'relative',overflow:'hidden',borderRadius:34,background:'radial-gradient(circle at 86% 15%,rgba(78,242,143,.28),transparent 24%),linear-gradient(125deg,#07130d,#10331f 68%,#185237)',color:'#fff',padding:'70px 64px',boxShadow:'0 32px 85px rgba(7,30,17,.18)'}}>
    ...
    <section className="genericOfferBenefits" style={{maxWidth:1180,margin:'24px auto',padding:'0 22px',display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))',gap:14}}>
      {[
    ...
    <section className="genericOfferFinal" style={{maxWidth:1180,margin:'26px auto 70px',padding:'0 22px'}}>
