  ...
  try {
    ...
    return NextResponse.json({
      ...
      products: products.map((product: any) => ({
        ...
        advertiser: product.Advertiser ?? product.MerchantName ?? product.RetailerName ?? product.StoreName,
        programId: product.ProgramId ?? product.ProgramID ?? product.CampaignId ?? product.CampaignID,
        programName: product.ProgramName ?? product.CampaignName,
